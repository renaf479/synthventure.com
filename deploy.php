 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', '5159479');
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'git@github.com:serenatc/synthventure.com.git');
 ...
 * @var string
 */
if (!defined('BRANCH')) define('BRANCH', 'prod');
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', '/home1/williefu/public_html/synthventure.com/');
 ...
 * @var string Full path including the trailing slash
 */
if (!defined('TMP_DIR')) define('TMP_DIR', '/home1/williefu/public_html/synthventure.com/tmp/spgd-'.md5(REMOTE_REPOSITORY).'/');
