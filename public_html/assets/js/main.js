...
;angular.module('synthApp').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('synth-logo.html',
    "<svg class=logo version=1.1 id=Layer_1 xmlns=http://www.w3.org/2000/svg xmlns:xlink=http://www.w3.org/1999/xlink x=0px y=0px viewbox=\"0 0 461.8 125\" enable-background=\"new 0 0 461.8 125\" xml:space=preserve><g><path d=\"M88,0c0.1,2.2,0.3,4.5,0.4,7.4c-8.1,0-15.6,0.6-22.9-0.1c-8.4-0.8-14.5,2.8-20.7,7.8C33,24.7,30.5,36.9,34.1,51\n" +
    ...
    "\t\tC6,28,5.8,37.3,11.4,46.1c4.8,7.6,11.7,12.3,21.8,12.3C25.7,40,26.3,23.2,40.9,7.9z\"><path d=\"M456,125c-0.1-14.1-0.4-28.3-0.4-42.4c0-12.6-4.3-23.3-14.6-30.8c-4.7-3.4-10.5-6.9-16-7.3c-14.4-1-28.9-0.3-44-0.3\n" +
    ...
    "\t\tc0,17.3,0,34.7,0,52C460.7,125,458.3,125,456,125z\"><path d=\"M195,125c0-8.6,0-17.3,0-26.6c-2.2,0-4.1,0-6.1,0c-11.7-0.1-23.4,0.3-35-0.4c-22-1.4-39.8-20.9-40.1-43\n" +
    ...
    "\t\tc21.5,2.6,38.5,21.6,38.5,43.4c0,14.8-0.1,29.6-0.1,44.4C310.7,125,308.3,125,306,125z\"><path d=\"M343,125c-7.3-3.2-10-8.7-9.9-16.6c0.3-31.7,0.1-63.3,0.1-95c0-2,0-3.9,0-6.2c2.8,0,5,0,8,0c0,9.7,0,19.4,0,29.5\n" +
    ...
    "\t\tc1.8,0.3,3.6,0.4,6.2,0.6c0,2.3,0,4.6,0,6.8C350.3,125,346.7,125,343,125z\"></g></svg>"
  );
